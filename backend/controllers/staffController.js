...
const publicStaffFields = `id, name, email, role, phone, department, job_title, address, emergency_contact, employment_date, status, created_at`;
const privateStaffFields = `id, name, email, role, phone, salary, department, job_title, address, emergency_contact, employment_date, status, created_at`;
...
export const createStaff = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `INSERT INTO users
        (name, email, password, role, phone, salary, department, job_title, address, emergency_contact, employment_date, status)
